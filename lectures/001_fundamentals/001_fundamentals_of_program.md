...
### Compiler
ทำหน้าที่แปรงชุดคำสั่ง high level ไปเป็นชุดคำสั่ง low level (instruction) และคอยตรวจสอบว่า ชุดคำสั่งที่เราเขียนใน high level ที่เราเขียน มีไวยากรณ์ที่ถูกต้องและเป็นไปตามกฏของภาษาหรือไม่
